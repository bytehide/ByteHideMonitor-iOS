Pod::Spec.new do |s|
  ...
  s.license               = { :type => "Commercial", :text => "Copyright (c) 2025-2026 ByteHide Solutions S.L. All rights reserved. Use requires a valid paid license." }
  ...
  s.source = {
    :http => "https://github.com/bytehide/ByteHideMonitor-iOS/releases/download/v1.0.11/ByteHideMonitor.xcframework.zip",
    :type => "zip"
  }
